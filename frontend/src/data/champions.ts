...
export const CHAMPIONS: Champion[] = [
  ...
  { name: "Nidalee", cost: 2, img: `${CDN}/Nidalee.png` },
  ...
  // ⭐⭐⭐⭐ 4 COST
  // ======================
  { name: "Aatrox", cost: 4, img: `${CDN}/Aatrox.png` },
  ...
  { name: "Yunara", cost: 4, img: `${CDN}/Yone.png` },
  ...
  { name: "Aurelion Sol", cost: 5, img: `${CDN}/AurelionSol.png` },
